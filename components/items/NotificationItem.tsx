...
//   // const now = new Date();
//   // const totalTime = notification.endTime.getTime() - notification.startTime.getTime();
//   // const timePassed = now.getTime() - notification.startTime.getTime();
//   // const remainingTime = notification.endTime.getTime() - now.getTime();
//   // const percentage= Math.min((timePassed / totalTime) * 100, 100);
  
//   // const isActivenotification = now >= notification.startTime && now <= notification.endTime;

//   // const noMidnight = notification.endTime.getHours() !== 0 && notification.endTime.getMinutes() !== 0;
//   // // check in how many days the notification ends
//   // const daysToEnd = noMidnight ? notification.endTime.getDate() - date.getDate() : notification.endTime.getDate() - date.getDate() - 1;
